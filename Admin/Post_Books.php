                ...
                <div class="">
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="input_field"> <span><i aria-hidden="true" class="fa fa-user"></i></span>
                      <input type="text" name="author" placeholder="Enter Book Author name" required />
                    </div>
                    <div class="input_field"> 
                      <span><i class="fa fa-calendar"></i></span>  <input type="date" name="date" placeholder="Enter publication date of book" required />
                    </div>
                    <div class="row clearfix">
                      <div class="col_half">
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-book"></i></span>
                          <input type="text" name="type" placeholder="Enter type of book" />
                        </div>
                      </div>
                      <div class="col_half">
                        <div class="input_field"> <span><i aria-hidden="true" class="fa fa-book"></i></i></span>
                          <input type="text" name="detail" placeholder="Enter Book details" required />
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="input_field">
                        ...
                        <input type="file" name="ufile" placeholder="Upload Book Image" required />
                      </div>
                        ...
                        <div class="input_field"> 
                          ...
                          <input type="file" name="upload" placeholder="Upload Book"  accept=".pdf" required />
                        </div>
