...
<?php
include"connection.php";
$sqll="SELECT * FROM registration where usertype='user' ";
$queryy=mysqli_query($con,$sqll);
$num_user=mysqli_num_rows($queryy);
if($num_user==0)
{
    echo "<h3>Record Not Available</h3>";
}
...
<?php
include"connection.php";
$sqll="SELECT distinct useremail FROM bookapplied";
$book_applied_queryy=mysqli_query($con,$sqll);
$num_applied=mysqli_num_rows($book_applied_queryy);
?>
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head"> Posted Books</p>
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            ...
                            <h2 class="text-white"> <span ><?php echo $num_user;?></span>
                            </h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                    <div class="card bg-primary">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">User Applied Books</p>
                            <h2 class="text-white"><span><?php echo $num_applied;?></span>
                            </h2>
                          </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">Posted Books</p>
                      ...
                      <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">User</p>
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                <h3 class="m-0 survey-value"><?php echo $num_user;?></h3>
                      ...
                      <div class="col-sm-4">
                        <div class="card">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head"> User Applied Books</p>
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                <h3 class="m-0 survey-value"><?php echo $num_applied;?></h3>
                              </div>
