...
include "connection.php";
$emailid=$ress['email'];
$sql="SELECT distinct b.bname,b.bauthor,b.bdate,b.bdetail,b.bimage,b.btype,b.bid FROM book b INNER JOIN bookapplied a on b.bid=a.bid where a.useremail='$emailid'";
$queries=mysqli_query($con,$sql);
$nums = mysqli_num_rows($queries);
while($f=mysqli_fetch_array($queries))
{
?>  
      ...
      <div class="col-md-10 mt-5 pt-5">
          <div class="row z-depth-3 ">
            <div class="col-sm-4 bg-info ronded-left ">                
                   <img class="card-img-top mt-1" src="../Admin/upload/<?php echo $f['bimage'];?>"  alt="Card image cap" width="350px;" height="300px">  
                  <a href="text.php?id=<?php echo $f['bid']?>" class="btn btn-warning form-control  mt-1 mb-1">View Book</a>
                  

            </div>
            <div class="col-sm-8 bg-white rounded-right">
                <h3 class="mt-3 text-center font-weight-bold"><?php echo $f['bname'];?></h3>
                <hr class="badge-primary mt-0 w-25">
                <div class="row">
                    <div class="col-sm-6">
                        <p class="font-weight-bold">Book Author:</p>
                        <h6 class="text-muted"><?php echo $f['bauthor'];?></h6>
                    </div>
                    <div class="col-sm-6">
                      <p class="font-weight-bold">Book Type:</p>
                      <h6 class="text-muted"><?php echo $f['btype'];?></h6>
                  </div>
                </div>
                <div class="row mt-3">
                  <div class="col-sm-6">
                      <p class="font-weight-bold">Book Detail:</p>
                      <h6 class="text-muted"><?php echo $f['bdetail'];?></h6>
                  </div>
                  <div class="col-sm-6">
                    <p class="font-weight-bold">Book Publish Year:</p>
                    <h6 class="text-muted"><?php echo $f['bdate'];?></h6>
                </div>
              </div>
