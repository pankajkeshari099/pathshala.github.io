          ...
          <li class="nav-item nav-profile">
            ...
            <br><br>
              <div class="nav-profile-text d-flex flex-column pr-3">
                <span>Welcome in Pathshala!!</span><br>
      ...
      <div class="col-md-10 mt-5 pt-5">
          <div class="row z-depth-3 ">
            <div class="col-sm-4 bg-info ronded-left ">                
                  ...
                  <button class="btn btn-warning form-control  mt-1 mb-1" value="Apply" name="apply">Apply</button>          
...
{ 
    ...
    $sqll="INSERT INTO  bookapplied(bid,useremail) VALUES('$idd','$emaill')"; 
